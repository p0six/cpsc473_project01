...
my_events_json = [
   ...
   {
      "start": unix_time_millis(datetime.datetime(2020, 12, 13, 20, 0, 0, 0)),
      "end": unix_time_millis(datetime.datetime(2020, 12, 13, 23, 0, 0, 0)),
      "title":"Rezz",
   ...
   {
      "start": unix_time_millis(datetime.datetime(2020, 12, 8, 20, 0, 0, 0)),
      "end": unix_time_millis(datetime.datetime(2020, 12, 8, 23, 0, 0, 0)),
   ...
   {
      "start": unix_time_millis(datetime.datetime(2020, 11, 17, 20, 0, 0, 0)),
      "end": unix_time_millis(datetime.datetime(2020, 11, 17, 23, 0, 0, 0)),
   ...
   {
      "start": unix_time_millis(datetime.datetime(2020, 11, 30, 20, 0, 0, 0)),
      "end": unix_time_millis(datetime.datetime(2020, 11, 30, 23, 0, 0, 0)),
      "title":"Say Anything",
   ...
   {
      "start": unix_time_millis(datetime.datetime(2020, 11, 3, 20, 0, 0, 0)),
      "end": unix_time_millis(datetime.datetime(2020, 11, 3, 23, 0, 0, 0)),
      "title":"Yelawolf",
